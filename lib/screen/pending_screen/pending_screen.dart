...
/// Displays all pending lab requests pulled from Firestore.
          ...
          children: [
            ...
            Align(
              ...
              child: Chip(
                ...
                backgroundColor: request.urgency.toLowerCase() == 'urgent'
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          'New client submissions or lab-created forms will appear here.',
